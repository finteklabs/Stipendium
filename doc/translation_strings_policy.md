...
This document provides guidelines for internationalization of the Stipendium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `stipendium_en.ts` remains unchanged.
