...
This mechanism has been integrated into Bitcore-Node-Stipendium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stipendiumpay/insight-api-stipendium#web-socket-api](https://github.com/stipendiumpay/insight-api-stipendium#web-socket-api)
* API: [https://github.com/stipendiumpay/insight-api-stipendium#instantsend-transactions](https://github.com/stipendiumpay/insight-api-stipendium#instantsend-transactions)
