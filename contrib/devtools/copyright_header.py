...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Stipendium Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a Stipendium Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Stipendium Core developers'
...
Arguments:
    <base_directory> - The base directory of Stipendium Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Stipendium Core repository.
"""
