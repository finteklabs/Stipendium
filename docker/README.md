...
official/supported Docker Images found at https://hub.docker.com/r/stipendiumpay/stipendiumd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/stipendiumpay/stipendiumd-develop/ when changing the above text**