...
2. run stipendiumd with -printalert or -sendalert like this:
   /path/to/stipendiumd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.stipendium.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Stipendium Core:0.12.0.58/"));
