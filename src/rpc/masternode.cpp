...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Stipendium address\n"
            "  payee          - Print the masternode payout Stipendium address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Stipendium address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "stipendium",               "masternode",             &masternode,             true,  {} },
    { "stipendium",               "masternodelist",         &masternodelist,         true,  {} },
    { "stipendium",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "stipendium",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
