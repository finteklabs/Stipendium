...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Stipendium related functionality
...
/*
    ...
    allow endless transaction that would bloat Stipendium and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Stipendium specific functionality
